...
public class CustomerController {
    ...
    public ResponseEntity<Customer> createGreeting(
        ...
        Customer savedGreeting = customerServicer.saveCustomer(customer);
    ...
    public void createGreeting() {
        ...
        Customer savedGreeting = customerServicer.saveCustomer(customer2);
